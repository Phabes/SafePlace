...
import {
  getHousingAreaTypesToSelect,
  getHousingTypesToSelect,
  getUserExpirienceTypesToSelect,
  getUserLifestyleTypesToSelect,
} from "../../../utils/getUserSelectData";
...
export const UserProfile = () => {
  ...
  const { userProfileControl, handleUserProfileSubmit, userProfileErrors } =
    useUserData(userDetails);
  ...
  return (
    <LoadingWrapper isLoading={loading} text="Loading user data...">
      <View>
        ...
        <AddImageModal
          onPressFunction={getProfilePhoto}
          isVisible={profileModalVisible}
          setVisible={setProfileModalVisible}
        />
        <AddImageModal
          onPressFunction={getBackgroundPhoto}
          isVisible={backgroundModalVisible}
          setVisible={setBackgroundModalVisible}
        />
        ...
        <View style={styles.formContainer}>
          ...
          <FormLabel
            text={"Experience"}
            errors={userProfileErrors.experience}
          />
          <Controller
            control={userProfileControl}
            name="experience"
          ...
          />
          <FormLabel text={"Housing Area"} errors={userProfileErrors.area} />
          <Controller
            control={userProfileControl}
            name="area"
            render={({ field: { onChange, value, name } }) => (
