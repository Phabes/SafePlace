...
export const FilteringPopUp: FC<ModalProps> = ({
  onPressFunction,
  isVisible,
  setVisible,
}) => {
  ...
  const { filterControl, handleFilterSubmit, filterErrors } =
    useFilteringData();
    ...
    <Modal isVisible={isVisible} onBackdropPress={() => setVisible(false)}>
      <View style={styles.container}>
        <View style={styles.verticalContainer}>
          ...
          <FormLabel
            text={"Base on User Profile"}
            errors={filterErrors.useUserDetails}
          />
          <Controller
          ...
          <Controller
            ...
            render={({ field: { onChange, value, name } }) => (
              <Input
                ...
                onChange={(age) =>
                  onChange(parseInt(age !== "" ? age : "0", 10))
                }
